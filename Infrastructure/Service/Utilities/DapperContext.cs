...
namespace Gpay.Infrastructure.Sevices.Utilities
{
    public class DapperContext : IDapperContext
    {
        ...
        public IDbConnection GetDbConnection()
        {
           ...
           public IDbConnection OctaveConnection()
        {
            string connectionString = configuration.GetConnectionString("OctaveConnection");
            return new NpgsqlConnection(connectionString);
        }
